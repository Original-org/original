...
export namespace original {
    class Trivial : OnCopy<>, OnMove<> {};

    class MoveOnly : OnCopy<copy::Disabled>, OnMove<> {};

    class CopyOnly : OnCopy<>, OnMove<move::Disabled> {};

    class Immobile : OnCopy<copy::Disabled>, OnMove<move::Disabled> {};
}